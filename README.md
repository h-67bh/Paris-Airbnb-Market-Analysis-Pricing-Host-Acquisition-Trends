...
# Takeaway: 
In premium markets, pricing does not scale linearly with capacity. There are distinct price jumps at specific accommodation thresholds (e.g., moving from a 10-person to a 12-person capacity), highlighting potential optimization points for property investors.
